<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="javascript:;" class="brand-link" style="text-align:center ; ">
      <span class="brand-text font-weight-light" style="font-size: 20px ; font-weight:bold ;">Ali Moubarak School</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('admin/student')}}" class="nav-link @if (Request::segment(2)== 'student') active @endif">
              <i class="fa fa-user"></i>
              <p> Student              </p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{url('admin/assign')}}" class="nav-link @if (Request::segment(2)== 'assign') active @endif">
              <i class="fa fa-user"></i>
              <p>  Assign Subjects              </p>
            </a>
          </li>
